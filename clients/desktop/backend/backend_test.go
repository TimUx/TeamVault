...
func TestSettingsRoundTrip(t *testing.T) {
	...
	in := Settings{ServerURL: "https://vault.example.test", TenantSlug: "acme", Username: "alice", AutostartOn: true, CloseToTray: true, PreventScreenCapture: true, Theme: "dark", Accent: "teal"}
