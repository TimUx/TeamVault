...
| 3 | Credential actions | Show the compact icon action buttons for one entry | One row highlighted with the Ausfüllen/Fill and Kopieren/Copy icons visible | 1280×800 or popup-only | Same demo entry as #2 |
...
| 7 | Lock / Security | Show the Lock/Logout controls | Unlocked vault view with the "Sperren" (Lock) and "Logout" icons visible | 360×~400 or 1280×800 | Same demo entries as #2 |
...
Screenshots zeigen die aktuellen TeamVault-Icons und die kompakten
Icon-Aktionsbuttons.
